...
<body>
    <header>
        <a href="../anon/homepage.php"><img class="logo" src="../images/hem_logo_circle_yellow.png"
                alt="logo"></a>
        <a href="../anon/homepage.php" class="web_name1" style="font-size:3vw;">Hẻm Decor</a>
        ...
        <div class="icons1">
            <a href="../anon/view_cart.php" class="fas fa-shopping-cart">
            </a>
            <div class="dropdown"><a class="fas fa-user"></a>
                <div class="dropdown-content">
                    <a href="../anon/my-order.php">Đơn Của Tôi</a>
                    <a href="../user_account/login.php">Đăng Nhập</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="order_details_iner">
                        ...
                        while ($row1 = mysqli_fetch_assoc($sql1)){ ?>
                                <tr>
                                    <td colspan="2">
                                        <span><a
                                                href='../anon/view_product.php?cid=<?php echo $row1['CategoryID']; ?>&pid=<?php echo $row1['ProductID']; ?>'>

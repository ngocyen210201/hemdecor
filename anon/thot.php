...
<body id="pro-page">
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="thot.php" class="active">Thớt</a>
                ...
                $page = $num/12;
                    ...
                    if(isset($_GET['sort'])){
                        if($_GET['sort'] == "new"){ //phân loại theo ngày thêm sp và thứ tự giảm dần
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='thot.php?sort=new&page=%s'>%s</a> ",
                            ...
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='thot.php?sort=low&page=%s'>%s</a> ",
                                    $i == $pageNow ? "class='current' " : "",
                                    $i,
                                    $i
                                );
                            ...
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='thot.php?sort=high&page=%s'>%s</a> ",
                                    $i == $pageNow ? "class='current' " : "",
                                    $i,
                                    $i
                                );

...
<body>
    ...
    <div class="heading"> Giới Thiệu </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 content">
                        <p>Hiện nay để tiếp cận gần với khách hàng các nhà hàng không chỉ chú trọng về không gian
                            ...
                            với nhiều đối tượng khách hàng, từ bạn trẻ cho đến nhân viên văn phòng.
                        </p>
        ...
        <section class="product">
            <div class="row">
                <div class="column">
                    <a href="khay.php"><img src="../images/homepage/khay.png" class="cate" width="400" height="400"></a>
                    <div class=des>Khay</div>
                </div>
                <div class="column">
                    <a href="thot.php"><img src="../images/homepage/thớt.png" class="cate" width="400" height="400"></a>
                    <div class=des>Thớt</div>
                </div>
                <div class="column">
                    <a href="khac.php"><img src="../images/homepage/khác.png" class="cate" width="400" height="400"></a>

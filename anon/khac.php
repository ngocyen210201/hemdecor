...
<body id="pro-page">
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="khac.php" class="active">Khác</a>
    </div>
    <div class="main">
        ...
        <div class="container-p" id="1">
            <?php
                ...
                $all_products = mysqli_query(
                    ...
                    WHERE ProductName NOT LIKE 'Khay%' AND ProductName NOT LIKE 'Thot%'                    
                ...
                $page = $num/12;
                    ...
                    if(isset($_GET['sort'])){
                        if($_GET['sort'] == "new"){ //phân loại theo ngày thêm sp và thứ tự giảm dần
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='khac.php?sort=new&page=%s'>%s</a> ",
                            ...
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='khac.php?sort=low&page=%s'>%s</a> ",
                                    $i == $pageNow ? "class='current' " : "",
                                    $i,
                                    $i
                                );
                            ...
                            for ($i = 1; $i <= $page; $i++) {
                                printf(
                                    "<a %shref='khac.php?sort=high&page=%s'>%s</a> ",
                                    $i == $pageNow ? "class='current' " : "",
                                    $i,
                                    $i
                                );
    ...
    <div class="view-footer" style="bottom: 0; left: 0;right: 0; position:absolute;">
        <?php include '../header_footer/footer.php'; ?></div>
</body>

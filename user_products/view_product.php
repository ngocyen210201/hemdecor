        ...
        <div class="card">
            ...
            <div class="product-content">
                ...
                <div class="size">
                    ...
                    <div class="size2">
                        <?php
                                $sql3 = mysqli_query($con, "SELECT c.*, ProductID, ProductName, Size, Price, ProductQuantity
                                FROM categories c INNER JOIN product p ON c.CategoryID = p.CategoryID
                                WHERE c.CategoryID = '$cid' AND ProductQuantity > 0");
                ...
                <form action="add_cart.php?cid=<?php echo $cid?>" method="post" enctype="multipart/form-data"
                    ...
                    <p class="error" id="error" style="display: none;">Vui lòng chọn Size</p>

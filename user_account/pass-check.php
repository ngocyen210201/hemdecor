...
if (isset($_SESSION['id'])) { 
    ...
    $s = "SELECT * FROM `account` WHERE AccountID = '$id' && AccPassword = '$old_pass1'";
    ...
    if($num ==1 && strlen($new_pass) >= 6 && strlen($new_pass) <= 20 && $new_pass != $old_pass && $new_pass1 == $new_pass){
        ...
        $new = "update `account` set AccPassword = '$decrypt_pass' where AccountID = '$id' && AccPassword = '$old_pass1'";

...
$cartID = $row['CartID'];
$find_product = mysqli_query($con, "SELECT * FROM Product_Cart WHERE CartID = '$cartID'");
$num = mysqli_num_rows($find_product);
    ...
    <div class="main">
        ...
        <form action="save-change.php" method="post" enctype="multipart/form-data" id="myForm">
            <table width="100%">
                ...
                <?php
                    $sql1 = mysqli_query($con, "SELECT p.CategoryID, ProductQuantity, ThumbnailImage, p.*, CartID, Quantity FROM Categories c

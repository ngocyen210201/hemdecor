                ...
                <form action="" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image0" id="image0" accept="image/png, image/jpeg, image/jpg">
                            <div id="preview0"></div>
                        </div>
                        <!-- ảnh mô tả -->
                        <br>
                                ...
                                <table class="preview-img">
                                    <tr>
                                        <th><label for="image1">Ảnh 1</label> <input type="file" name="image1"
                                                accept="image/png, image/jpeg, image/jpg" id="image1"><span
                                                onclick="delImage(1)">&times;</span></th>
                                        <th><label for="image2">Ảnh 2</label> <input type="file" name="image2"
                                                accept="image/png, image/jpeg, image/jpg" id="image2"><span
                                                onclick="delImage(2)">&times;</span></th>
                                        <th><label for="image3">Ảnh 3</label> <input type="file" name="image3"
                                                accept="image/png, image/jpeg, image/jpg" id="image3"><span
                                                onclick="delImage(3)">&times;</span> </th>
                                        <th><label for="image4">Ảnh 4</label> <input type="file" name="image4"
                                                accept="image/png, image/jpeg, image/jpg" id="image4"><span
                                                onclick="delImage(4)">&times;</span> </th>
                                    </tr>
